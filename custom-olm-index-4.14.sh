...
declare -A OPERATORS=(
  ["ptp-operator"]="ptp-operator.v4.14.0-202403060538"
  ["local-storage-operator"]="local-storage-operator.v4.14.0-202403081610"
  ["sriov-network-operator"]="sriov-network-operator.v4.14.0-202402081809"
  )
